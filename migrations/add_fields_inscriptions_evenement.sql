...
COMMENT ON COLUMN inscriptions_evenement.profession IS 'Profession du participant';
COMMENT ON COLUMN inscriptions_evenement.entreprise IS 'Entreprise du participant';
COMMENT ON COLUMN inscriptions_evenement.secteur_activite IS 'Secteur d''activité';
...
COMMENT ON COLUMN inscriptions_evenement.regime_alimentaire IS 'Régime alimentaire particulier';
