-- =============================================
-- ADD FAVORITES TO HOME PAGE FUNCTIONS -- EDUSKY
-- =============================================

-- 1. Formations: Add p_user_id parameter and is_favorited boolean
CREATE OR REPLACE FUNCTION get_home_page_formations(p_user_id UUID DEFAULT NULL)
RETURNS TABLE (
    "id" uuid,
    "title" text,
    "description" text,
...
-- 2. Événements: Add p_user_id parameter and is_favorited boolean
CREATE OR REPLACE FUNCTION get_home_page_evenements(p_user_id UUID DEFAULT NULL)
RETURNS TABLE (
    "id" uuid,
    "title" text,
    "description" text,
...
-- 3. Articles de blog: Add p_user_id parameter and is_favorited boolean
CREATE OR REPLACE FUNCTION get_home_page_articles(p_user_id UUID DEFAULT NULL)
RETURNS TABLE (
    "id" uuid,
    "title" text,
    "excerpt" text,
...
-- 4. Clubs: Add p_user_id parameter and is_favorited boolean
CREATE OR REPLACE FUNCTION get_home_page_clubs(p_user_id UUID DEFAULT NULL)
RETURNS TABLE (
    "id" uuid,
    "name" text,
    "description" text,
...
-- 5. Professeurs: Add p_user_id parameter and is_favorited boolean
